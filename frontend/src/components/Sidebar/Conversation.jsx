...
const Conversation = ({lastIndex,item}) => {
  ...
  return (
    <>
    <div onClick = {()=> setSelectedConversation(item)}className={`flex h-20 gap-2 my-2 items-center hover:bg-teal-800 hover:rounded-3xl p-2 py-1 cursor-pointer ${isSelectedConversation?"bg-gradient-to-r from-green-800 to-teal-900":""}`}>
